...
#import "BUsequence.h"
#import "CUsequence.h"
@interface AUsequence ()

@end

@implementation AUsequence
...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[AUsequence alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[AUsequence alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            AUsequence *key = [[AUsequence alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        AUsequence *key = [[AUsequence alloc] initWithValue:data];
        _keyframes = @[key];
    }
