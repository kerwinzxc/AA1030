...
@property (nonatomic, readonly, nullable) AUsequence *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<AUsequence *> *keyframes;
