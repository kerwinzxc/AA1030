...
#import "UsequenceSdkImp.h"
@interface UsequenceChangePasswordViewController ()
...
@implementation UsequenceChangePasswordViewController
...
-(void)initNavigation {
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_icon_meun_change_pw.png"]];
...
-(void)changePassword {
    ...
    if ([newPassword length] == 0) {
        UsequenceProgressHUD *process = [[UsequenceProgressHUD alloc] initWithView:self.view];
        ...
        @try
        {
            ...
            if ((NSNull *)value == nil)
            {
                ...
                if([userinfo.tourist isEqualToString:@"1"]){
                    ...
                    nowPassword=[UsequenceSdkMd5 md5:self.nowPasswordField.text];
                }else{
                    
                    nowPassword=self.nowPasswordField.text;
                }
                
                [[[UsequenceDataBase alloc]init]updateUsequencePassword:nowPassword userName:userinfo.username];
    ...
    if([userinfo.tourist isEqualToString:@"1"]){
        ...
        oldPassword = [UsequenceSdkMd5 md5:self.oldPasswordField.text];
    }
    
    [[UsequenceWebInterface sharedInstance]changeUsequencePasswordWithTokenUsequence:self.accessToken oldPasswordUsequence:oldPassword newPasswordUsequence:[UsequenceSdkMd5 md5:newPassword] successCallbackUsequence:successCallback failCallbackUsequence:^(NSError *a) {
...
-(void)bindDespatch {
    ...
    [process showAnimated:YES whileExecutingBlock:^{
        ...
        while (self.changing)
        {
            ...
            [NSThread sleepForTimeInterval:1];
            if (count > 5) {
                UsequenceProgressHUD *errorHud = [[UsequenceProgressHUD alloc] initWithView:self.view];
