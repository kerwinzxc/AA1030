...
@interface UsequenceWindowTouch()
@property(nonatomic,strong)UsequencePopwidowViewController *popcontroller;
@property(nonatomic,unsafe_unretained)id<UsequenceWindowTouchDelegate> assistiveDelegate;
@property (nonatomic) float lastX;
@property (nonatomic) float lastY;
@end
@implementation UsequenceWindowTouch
...
-(id)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame])
    {
        ...
        self.popcontroller=[[UsequencePopwidowViewController alloc]initWithUsequencePopWindow:self];
