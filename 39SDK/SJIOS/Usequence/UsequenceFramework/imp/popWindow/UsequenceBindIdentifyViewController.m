...
#import  "UsequenceSdkImp.h"
@interface UsequenceBindIdentifyViewController ()
...
@property(nonatomic,strong) UsequenceBindIdentifyViewController *bindIdentifyVew;


@end

@implementation UsequenceBindIdentifyViewController
...
-(void)initNavigation {
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_icon_meun_shiming.png"]];
...
- (void)normalPressed
{
    ...
    if (verify.length == 0)
    {
        ...
        [self showUsequenceToast:@"请输入身份证号码"];
    ...
    if (verify.length != 18)
    {
        ...
        [self showUsequenceToast:@"身份证号码有误"];
        ...
        @try
        {
            ...
            if ((NSNull *)value == nil)
            {
                ...
                if (ok != nil)
                {
                    ...
                    [self showUsequenceToast:@"认证成功，请返回"];
                    [self dismissViewControllerAnimated:YES completion:^{
                    }];
                ...
                [self showUsequenceToast:@"身份证信息有误"];
                return;
            }
            else
            {
                
                [self showUsequenceToast:[[UsequenceSdkImp sharedInstance] translateUsequence:[dictionary valueForKey:@"error"]]];
            }
        }
        @catch(NSException * e)
        {
    ...
    [[UsequenceWebInterface sharedInstance] startUsequenceIdentify:self.accessToken nameUsequence:identifyNameField.text identifyNumberUsequence:identifyNumberField.text successCallbackUsequence:successCallback failCallbackUsequence:^(NSError *error) {
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    ...
    else if(textField==identifyNumberField)
    {
        ...
        if ([username length] == 0)
        {
            ...
            [[UsequenceSdkImp sharedInstance]showUsequenceToast:@"姓名为空"];
        ...
        {
            [[UsequenceSdkImp sharedInstance]showUsequenceToast:@"身份证为空"];
