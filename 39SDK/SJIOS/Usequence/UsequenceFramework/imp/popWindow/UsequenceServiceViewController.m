...
@interface UsequenceServiceViewController ()
...
@implementation UsequenceServiceViewController
...
-(void)loadView {
    ...
    UIImage *callDefaultImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_icon_call_phone_default.png"]];
    UIImage *callDownImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_icon_call_phone_cl.png"]];
