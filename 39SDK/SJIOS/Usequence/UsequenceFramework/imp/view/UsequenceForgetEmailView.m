...
@interface UsequenceForgetEmailView()
...
@implementation UsequenceForgetEmailView
...
-(void)setLandScapeView{
 //   self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_background_landscape.png"]]];
    ...
    UIImage *bindPhonebackImage = [[UIImage alloc]initWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_login_button.png"]] ;
...
-(void)setPortraitView{
    ...
    self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_background_portrait.png"]]];
...
- (void)verifyPressed:(UIButton*)sender
{
    ...
    [[UsequenceWebInterface sharedInstance] changeUsequencePasswordByEmail:username
...
- (void)normalPressed:(UIButton*)sender
{
    ...
    [[UsequenceWebInterface sharedInstance] confirmUsequenceChangePasswordByEmail:username
