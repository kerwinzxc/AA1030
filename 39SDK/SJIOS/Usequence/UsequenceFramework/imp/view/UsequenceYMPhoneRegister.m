...
@interface UsequenceYMPhoneRegister()
...
@implementation UsequenceYMPhoneRegister
...
-(void)setLandScapeView{
    ...
    UIImage * logo_r = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_logo_s.png"]];
...
-(void)ym_verifyPressed:(id)sender {
    ...
    Usequence_VSD_BLOCK successCallback = ^(NSDictionary *dictionary, NSDictionary *headers) {
        ...
        @try
        {
            ...
            if ((NSNull *)value == nil)
            {
                ...
                [[UsequenceSdkImp sharedInstance]showUsequenceToast:@"获取验证码成功"];
                self.logining = false;
            ...
            else
            {
                ...
                self.myProcess.labelText = [[UsequenceSdkImp sharedInstance] translateUsequence:[dictionary valueForKey:@"error"]];
                self.myProcess.mode = UsequenceProgressHUDModeCustomView;
    ...
    [[UsequenceWebInterface sharedInstance] phoneUsequenceRegistVerify:self.ymPhoneNumber
...
//                [self setRandomAccount];
    ...
    [[UsequenceWebInterface sharedInstance] phoneUsequenceRegist:self.ymPhoneNumber
                                            passwordUsequence:self.password.text
                                          verifyCodeUsequence:self.verifyField.text
                                     successCallbackUsequence:successCallback
                                         failCallbackUsequence:^(NSError * error) {
                                             self.registering = false;
