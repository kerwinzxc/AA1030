...
#import "UsequenceAgreeView.h"
#import "UsequenceSdkImp.h"

@interface UsequenceAgreeView()
...
static NSString * LOG_TAG = @"UsequenceAgreeView";



@implementation UsequenceAgreeView
         ...
         landScape:(Boolean)landScape
{
    ...
    if (self) {
        ...
        self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_agreeBG.png"]]];
