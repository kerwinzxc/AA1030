...
#import "UsequenceYMBindPhoneView.h"
...
@interface UsequenceYMBindPhoneView()
...
@property(nonatomic,strong) UsequenceYMBindPhoneView *ymBindPhoneView;//忘记密码找回界面
...
@implementation UsequenceYMBindPhoneView
...
-(void)setLandScapeView{
    ...
    [closeButton setBackgroundImage:[UIImage imageNamed:@"Usequence.bundle/Usequence_ym_close.png"] forState:UIControlStateNormal];
    ...
    UIImage *verifybackImage = [[UIImage alloc]initWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Usequence.bundle/Usequence_login_button.png"]] ;
...
{
    UsequenceForgetEmailView *forgetView = [[UsequenceForgetEmailView alloc]initWithLandscape:self.landscape];
...
- (void)verifyPressed
{
    ...
    if (phone.length == 0)
    {
        ...
        [[UsequenceSdkImp sharedInstance]showUsequenceToast:@"请输入手机号"];
        return;
    }
    ...
    if(self.textIsphoneNumber){
        ...
        [[UsequenceWebInterface sharedInstance] bindUsequencePhone:self.accessToken
                                            phoneUsequence:phone
...
- (void)normalPressed
{
    ...
    if (username.length == 0)
    {
        ...
        [[UsequenceSdkImp sharedInstance]showUsequenceToast:@"手机号或者密码为空"];
        return;
    }
    ...
    if (verify.length == 0)
    {
        [[UsequenceSdkImp sharedInstance]showUsequenceToast:@"请输入验证码"];
        return;
...
//                    [self checkAccountIdentity:self.accessToken];//检查有没有实名
    ...
    [[UsequenceWebInterface sharedInstance] confirmUsequencePhone:self.accessToken
