...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[APostin alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[APostin alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            APostin *key = [[APostin alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        APostin *key = [[APostin alloc] initWithValue:data];
        _keyframes = @[key];
    }
