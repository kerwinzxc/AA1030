...
#import "PostinSettingViewController.h"
...
@interface PostinPopWindow()
@property (nonatomic) int show;
@property (nonatomic, strong)PostinSettingViewController *destionController;
@property (nonatomic, strong)PostinNavViewController *destionNavController;
...
@implementation PostinPopWindow


- (id)initWithFramePostinPopWindow:(CGRect)frame controller:(UIViewController *)controller landspace:(BOOL) landspace accessToken:(NSString *)accessToken
{
    ...
    -(void)setLandScapeView{
        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_leftBackground_hengban.png"]] ;
        self.leftBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.leftBackground.image = leftbackImage;
        
        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_rightBackground_hengban.png"]] ;
        self.rightBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.rightBackground.image = rightbackImage;
        
        UIImage *floatImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_company_logo.png"]];
        ...
        UIImage *userInfoImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_userinfo_server.png"]] ;
        ...
        UIImage *hideFloatPostinImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_hide.png"]] ;
        [self.ymFloatHideButton setImage:hideFloatPostinImage forState:UIControlStateNormal];
        [self.ymFloatHideButton addTarget:self action:@selector(ym_hidePostinPopWindow:) forControlEvents:UIControlEventTouchUpInside];
    ...
    -(void)setPortraitView{
        ...
        //        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_leftBackground.png"]] ;
        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_Background_shuban.png"]] ;
        self.leftBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.leftBackground.image = leftbackImage;
        
        //        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_rightBackground.png"]] ;
        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_Background_shuban.png"]] ;
        self.rightBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.rightBackground.image = rightbackImage;
...
-(void)setFloatButtonBackground{
    ...
    Postin_VSD_BLOCK successCallback = ^(NSDictionary *responseString, NSDictionary *headers) {
            ...
            UIImage *normalAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_userinfo_server.png"]] ;
        ...
        if([str containsString:@"failed"]){
            UIImage *floatImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_company_logo_nobind.png"]];
            [self.floatButton setImage:floatImage forState:UIControlStateNormal];
        }else{
            UIImage *floatImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_company_logo.png"]];
            [self.floatButton setImage:floatImage forState:UIControlStateNormal];
...
-(void) showPop{
    PostinUserCenterView *usercenter = [[PostinUserCenterView alloc] initPostinUserCenterView:self.landscape accessToken:self.accessToken];
    [usercenter showPostinUserCenterView:[UIApplication sharedApplication].keyWindow.rootViewController.view];
...
-(void)serviceClick{
    if (self.controller == nil) {
        ...
        if (self.destionController == nil) {
            self.destionController = [[PostinSettingViewController alloc]initWithTransitionStyle:UIPageViewControllerTransitionStyleScroll navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal options:NULL];
            self.destionNavController = [[PostinNavViewController alloc]initWithRootViewController:self.destionController];
...
//隐藏悬浮框
-(void)ym_hidePostinPopWindow:(id)sender {
