...
@interface PostinForgetEmailView()
...
@implementation PostinForgetEmailView
...
-(void)setLandScapeView{
 //   self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_background_landscape.png"]]];
    ...
    UIImage *bindPhonebackImage = [[UIImage alloc]initWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_login_button.png"]] ;
...
-(void)setPortraitView{
    ...
    self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_background_portrait.png"]]];
...
- (void)verifyPressed:(UIButton*)sender
{
    ...
    [[PostinWebInterface sharedInstance] changePostinPasswordByEmail:username
...
- (void)normalPressed:(UIButton*)sender
{
    ...
    [[PostinWebInterface sharedInstance] confirmPostinChangePasswordByEmail:username
