...
@property(nonatomic,strong)  PostinYMPhoneLogin *ymPhoneLogin;//手机登录
...
@implementation PostinYMPhoneLogin



- (id)initWithBlock:(Postin_SUCCESS_Callback)success failed:(Postin_FAILED_Callback)failed
          landScape:(Boolean)landscape  view:(PostinQuickLogin*) view ymPhoneNumber:(NSString *)ymPhoneNum
...
-(void)ymdismissWithAnimation:(BOOL)animated
{
    ...
    [[PostinSdkImp sharedInstance] showPostinWelcome:self.ymPhoneNumber];
