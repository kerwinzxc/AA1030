...
#import "PostinPopwidowViewController.h"
...
@interface PostinPopwidowViewController ()
...
@property (assign,nonatomic)id<PostinShowController> delegate;
@end

@implementation PostinPopwidowViewController
...
-(void)setPopView{
    ...
    UIImage *backImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_float_background.png"]] ;
    ...
    UIImage *normalServiceImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_icon_ser.png"]] ;
    UIImage *pressedServiceImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_icon_ser_cl.png"]] ;
    ...
    UIImage *normalAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_icon_ac.png"]] ;
    UIImage *pressedAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_icon_ac_cl.png"]] ;
