...
#import  "PostinSdkImp.h"
@interface PostinBindPhoneViewController ()
...
@implementation PostinBindPhoneViewController
...
-(void)initNavigation {
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Postin.bundle/Postin_icon_meun_bangding.png"]];
