...
#import "QroughtAgreeView.h"
#import "QroughtSdkImp.h"

@interface QroughtAgreeView()
...
static NSString * LOG_TAG = @"QroughtAgreeView";



@implementation QroughtAgreeView
         ...
         landScape:(Boolean)landScape
{
    ...
    if (self) {
        ...
        self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_agreeBG.png"]]];
