...
@interface QroughtForgetEmailView()
...
@implementation QroughtForgetEmailView
...
-(void)setLandScapeView{
 //   self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_background_landscape.png"]]];
    ...
    UIImage *bindPhonebackImage = [[UIImage alloc]initWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_login_button.png"]] ;
...
-(void)setPortraitView{
    ...
    self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_background_portrait.png"]]];
...
- (void)verifyPressed:(UIButton*)sender
{
    ...
    [[QroughtWebInterface sharedInstance] changeQroughtPasswordByEmail:username
...
- (void)normalPressed:(UIButton*)sender
{
    ...
    [[QroughtWebInterface sharedInstance] confirmQroughtChangePasswordByEmail:username
