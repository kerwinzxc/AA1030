...
@property(nonatomic,strong)  QroughtYMPhoneLogin *ymPhoneLogin;//手机登录
@property(nonatomic,strong)  QroughtYMPhoneRegisterView *ymPhoneRegisterView;//注册
...
@property (nonatomic, strong)QroughtProgressHUD *myProcess;
...
@implementation QroughtYMPhoneLogin



- (id)initWithBlock:(Qrought_SUCCESS_Callback)success failed:(Qrought_FAILED_Callback)failed
          landScape:(Boolean)landscape  view:(QroughtQuickLogin*) view ymPhoneNumber:(NSString *)ymPhoneNum
...
-(void)ymdismissWithAnimation:(BOOL)animated
{
    ...
    [[QroughtSdkImp sharedInstance] showQroughtWelcome:self.ymPhoneNumber];
    
    [[QroughtWebInterface sharedInstance] QroughtsendHeart:self.code];
...
//        [alertView show];
        ...
        [[QroughtSdkImp sharedInstance] showQroughtToast:@"注册成功！帐号信息截图已保存到相册中，帐号丢失可以查看截图找回，请妥善保管！"];
    }else{
        NSLog(@"save error");
