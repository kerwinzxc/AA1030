...
#import "QroughtSettingViewController.h"
...
@interface QroughtPopWindow()
@property (nonatomic) int show;
@property (nonatomic, strong)QroughtSettingViewController *destionController;
@property (nonatomic, strong)QroughtNavViewController *destionNavController;
...
@implementation QroughtPopWindow
...
- (id)initWithFrameQroughtPopWindow:(CGRect)frame controller:(UIViewController *)controller landspace:(BOOL) landspace accessToken:(NSString *)accessToken
{
    ...
    -(void)setLandScapeView{
        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_leftBackground_hengban.png"]] ;
        self.leftBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.leftBackground.image = leftbackImage;
        
        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_rightBackground_hengban.png"]] ;
        self.rightBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.rightBackground.image = rightbackImage;
        
        UIImage *floatImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_company_logo.png"]];
        ...
        UIImage *userInfoImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_userinfo_server.png"]] ;
        ...
        UIImage *hideFloatQroughtImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_hide.png"]] ;
        [self.ymFloatHideButton setImage:hideFloatQroughtImage forState:UIControlStateNormal];
        [self.ymFloatHideButton addTarget:self action:@selector(ym_hideQroughtPopWindow:) forControlEvents:UIControlEventTouchUpInside];
    ...
    -(void)setPortraitView{
        ...
        //        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_leftBackground.png"]] ;
        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_Background_shuban.png"]] ;
        self.leftBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.leftBackground.image = leftbackImage;
        
        //        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_rightBackground.png"]] ;
        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_Background_shuban.png"]] ;
        self.rightBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.rightBackground.image = rightbackImage;
...
-(void)setFloatButtonBackground{
    ...
    Qrought_VSD_BLOCK successCallback = ^(NSDictionary *responseString, NSDictionary *headers) {
            ...
            UIImage *normalAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_userinfo_server.png"]] ;
        ...
        if([str containsString:@"failed"]){
            UIImage *floatImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_company_logo_nobind.png"]];
            [self.floatButton setImage:floatImage forState:UIControlStateNormal];
        }else{
            UIImage *floatImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_company_logo.png"]];
            [self.floatButton setImage:floatImage forState:UIControlStateNormal];
...
-(void) showPop{
    QroughtUserCenterView *usercenter = [[QroughtUserCenterView alloc] initQroughtUserCenterView:self.landscape accessToken:self.accessToken];
    [usercenter showQroughtUserCenterView:[UIApplication sharedApplication].keyWindow.rootViewController.view];
...
-(void)serviceClick{
    if (self.controller == nil) {
        ...
        if (self.destionController == nil) {
            self.destionController = [[QroughtSettingViewController alloc]initWithTransitionStyle:UIPageViewControllerTransitionStyleScroll navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal options:NULL];
            self.destionNavController = [[QroughtNavViewController alloc]initWithRootViewController:self.destionController];
...
//隐藏悬浮框
-(void)ym_hideQroughtPopWindow:(id)sender {
