...
@interface QroughtWindowTouch()
@property(nonatomic,strong)QroughtPopwidowViewController *popcontroller;
@property(nonatomic,unsafe_unretained)id<QroughtWindowTouchDelegate> assistiveDelegate;
@property (nonatomic) float lastX;
@property (nonatomic) float lastY;
@end
@implementation QroughtWindowTouch
...
-(id)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame])
    {
        ...
        self.popcontroller=[[QroughtPopwidowViewController alloc]initWithQroughtPopWindow:self];
