...
#import "QroughtPopwidowViewController.h"
...
@interface QroughtPopwidowViewController ()
...
@property (assign,nonatomic)id<QroughtShowController> delegate;
@end

@implementation QroughtPopwidowViewController
-(id)initWithQroughtPopWindow:(UIWindow *) window{
    self=[super init];
    if (self) {
...
-(void)setPopView{
    ...
    UIImage *backImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_float_background.png"]] ;
    ...
    UIImage *normalServiceImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_ser.png"]] ;
    UIImage *pressedServiceImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_ser_cl.png"]] ;
    ...
    UIImage *normalAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_ac.png"]] ;
    UIImage *pressedAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_ac_cl.png"]] ;
