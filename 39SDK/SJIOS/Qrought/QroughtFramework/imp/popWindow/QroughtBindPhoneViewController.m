...
#import  "QroughtSdkImp.h"
@interface QroughtBindPhoneViewController ()
...
@implementation QroughtBindPhoneViewController
...
-(void)initNavigation {
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_meun_bangding.png"]];
