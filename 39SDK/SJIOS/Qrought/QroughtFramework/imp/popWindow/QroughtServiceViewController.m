...
@interface QroughtServiceViewController ()
...
@implementation QroughtServiceViewController
...
-(void)loadView {
    ...
    UIImage *callDefaultImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_call_phone_default.png"]];
    UIImage *callDownImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_call_phone_cl.png"]];
