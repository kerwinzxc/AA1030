...
#import  "QroughtSdkImp.h"
@interface QroughtBindEmailViewController ()
...
@implementation QroughtBindEmailViewController
...
-(void)initNavigation {
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Qrought.bundle/Qrought_icon_meun_bangemail.png"]];
...
- (void)normalPressed
{
    ...
    Qrought_VSD_BLOCK successCallback = ^(NSDictionary *dictionary, NSDictionary *headers) {
     ...
     [[QroughtWebInterface sharedInstance] bindQroughtMail:self.accessToken emailQrought:verify successQroughtCallback:successCallback failQroughtCallback:^(NSError *error) {
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    if (textField == self.phoneNumberField)
    {
        ...
        if ([username length] == 0)
        {
            ...
            [[QroughtSdkImp sharedInstance]showQroughtToast:@"邮箱为空"];
