...
@property (nonatomic, readonly, nullable) AQrought *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<AQrought *> *keyframes;
