...
@property (nonatomic, readonly, nullable) ARersistence *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<ARersistence *> *keyframes;
