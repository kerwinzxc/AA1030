...
@interface CRersistence : NSObject
...
@property(nonatomic, strong, readwrite) CRersistence *phoneUtil;
@property(nonatomic, strong, readwrite) CRersistence *currentMetaData, *defaultMetaData;
@end
