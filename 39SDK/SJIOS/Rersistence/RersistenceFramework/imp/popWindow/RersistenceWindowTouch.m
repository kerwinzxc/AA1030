...
@interface RersistenceWindowTouch()
@property(nonatomic,strong)RersistencePopwidowViewController *popcontroller;
@property(nonatomic,unsafe_unretained)id<RersistenceWindowTouchDelegate> assistiveDelegate;
@property (nonatomic) float lastX;
@property (nonatomic) float lastY;
@end
@implementation RersistenceWindowTouch
...
-(id)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame])
    {
        ...
        self.popcontroller=[[RersistencePopwidowViewController alloc]initWithRersistencePopWindow:self];
