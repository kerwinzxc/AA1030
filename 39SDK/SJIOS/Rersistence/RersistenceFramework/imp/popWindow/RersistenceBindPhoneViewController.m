...
#import  "RersistenceSdkImp.h"
@interface RersistenceBindPhoneViewController ()
...
@implementation RersistenceBindPhoneViewController
...
-(void)initNavigation {
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_icon_meun_bangding.png"]];
