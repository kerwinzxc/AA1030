...
#import "RersistencePopwidowViewController.h"
...
@interface RersistencePopwidowViewController ()
...
@property (assign,nonatomic)id<RersistenceShowController> delegate;
@end

@implementation RersistencePopwidowViewController
...
-(void)setPopView{
    ...
    UIImage *backImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_float_background.png"]] ;
    ...
    UIImage *normalServiceImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_icon_ser.png"]] ;
    UIImage *pressedServiceImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_icon_ser_cl.png"]] ;
    ...
    UIImage *normalAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_icon_ac.png"]] ;
    UIImage *pressedAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_icon_ac_cl.png"]] ;
