...
@interface RersistenceServiceViewController ()
...
@implementation RersistenceServiceViewController
...
-(void)loadView {
    ...
    UIImage *callDefaultImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_icon_call_phone_default.png"]];
    UIImage *callDownImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_icon_call_phone_cl.png"]];
