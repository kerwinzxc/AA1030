...
@interface RersistenceYMPhoneLogin()
...
@property(nonatomic,strong)  RersistenceYMPhoneLogin *ymPhoneLogin;//手机登录
...
@implementation RersistenceYMPhoneLogin



- (id)initWithBlock:(Rersistence_SUCCESS_Callback)success failed:(Rersistence_FAILED_Callback)failed
          landScape:(Boolean)landscape  view:(RersistenceQuickLogin*) view ymPhoneNumber:(NSString *)ymPhoneNum
...
-(void)ymdismissWithAnimation:(BOOL)animated
{
    ...
    [[RersistenceSdkImp sharedInstance] showRersistenceWelcome:self.ymPhoneNumber];
