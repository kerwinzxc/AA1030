...
#import "RersistenceAgreeView.h"
#import "RersistenceSdkImp.h"

@interface RersistenceAgreeView()
...
static NSString * LOG_TAG = @"RersistenceAgreeView";



@implementation RersistenceAgreeView
         ...
         landScape:(Boolean)landScape
{
    ...
    if (self) {
        ...
        self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_agreeBG.png"]]];
