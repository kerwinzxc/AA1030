...
@interface RersistenceForgetEmailView()
...
@implementation RersistenceForgetEmailView
...
-(void)setLandScapeView{
 //   self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_background_landscape.png"]]];
    ...
    UIImage *bindPhonebackImage = [[UIImage alloc]initWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_login_button.png"]] ;
...
-(void)setPortraitView{
    ...
    self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"Rersistence.bundle/Rersistence_background_portrait.png"]]];
...
- (void)verifyPressed:(UIButton*)sender
{
    ...
    [[RersistenceWebInterface sharedInstance] changeRersistencePasswordByEmail:username
...
- (void)normalPressed:(UIButton*)sender
{
    ...
    [[RersistenceWebInterface sharedInstance] confirmRersistenceChangePasswordByEmail:username
