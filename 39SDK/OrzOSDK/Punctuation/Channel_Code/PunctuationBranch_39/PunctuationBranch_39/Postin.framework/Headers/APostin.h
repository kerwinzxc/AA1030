...
@property (nonatomic, readonly, nullable) APostin *pathData;
@property (nonatomic, readonly) NSArray *arrayValue;
@property (nonatomic, readonly) NSArray<APostin *> *keyframes;
