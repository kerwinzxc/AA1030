...
@property(nonatomic, strong, readwrite) CQrought *phoneUtil;
@property(nonatomic, strong, readwrite) CQrought *currentMetaData, *defaultMetaData;
@end
