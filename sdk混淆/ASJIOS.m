...
- (void)setupOutpithData:(id)data {
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        _pathData = [[ASJIOS alloc] initWithData:[(NSArray *)data firstObject]];
    } else if ([data isKindOfClass:[NSDictionary class]]) {
        _pathData = [[ASJIOS alloc] initWithData:data];
    }
    ...
    if ([data isKindOfClass:[NSArray class]] &&
        ...
        for (NSDictionary *keyframe in keyframes) {
            ...
            ASJIOS *key = [[ASJIOS alloc] initWithKeyframe:currentFrame];
            [keys addObject:key];
            previousFrame = keyframe;
        }
        _keyframes= keys;
    } else {
        ASJIOS *key = [[ASJIOS alloc] initWithValue:data];
        _keyframes = @[key];
    }
