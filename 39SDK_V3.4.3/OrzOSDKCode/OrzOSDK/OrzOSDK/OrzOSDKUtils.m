...
//#define OrzOSDK_SERVER_URL1 @"https://sandbox.j"
...
//                        [alert addAction:defaultAction];
//                        [[[OrzOSDKBranch getSharedInstance] getOrzOSDKCurrentViewController] presentViewController:alert animated:YES completion:nil];
                        [[OrzOSDKUtils getSharedInstance] showOrzOSDKToastMsg:[json objectForKey:@"message"] view:[UIApplication sharedApplication].keyWindow.rootViewController.view];
                    }
                    //end 防拉人设置
