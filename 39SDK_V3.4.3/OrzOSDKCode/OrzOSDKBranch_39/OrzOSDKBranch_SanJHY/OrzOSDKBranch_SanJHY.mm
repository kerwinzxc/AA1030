...
-(void)doOrzOSDKChannelInit{
    ...
    [SJIOSSdk initSJIOS:[[OrzOSDKUtils getSharedInstance] getOrzOSDKInfoPlist_Landscape]
        SJIOS_Appid:[channel_config objectForKey:@"param_appid"]
       SJIOS_Appkey:[channel_config objectForKey:@"param_appkey"]
      SJIOS_Channel:[channel_config objectForKey:@"param_channel"]
    SJIOS_Appsecret:[channel_config objectForKey:@"param_appsecret"]
          SJIOS_Gid:[channel_config objectForKey:@"param_gid"]
     SJIOS_RYAppkey:[channel_config objectForKey:@"param_ryappkey"]
