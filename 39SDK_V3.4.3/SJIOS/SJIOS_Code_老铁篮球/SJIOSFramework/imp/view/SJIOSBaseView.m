    ...
    if (self) {
        ...
        self.parent = NULL;
            ...
            if (landScape) {
                 ...
                 self.alertContainer = [[UIAlertView alloc] initWithFrame:CGRectMake((rect.size.width-450)/2, (rect.size.height-250)/2, size.width, size.height)];
                ...
                self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"SJIOS.bundle/SJIOS_background_landscape.png"]]];
                 ...
                 self.alertContainer = [[UIAlertView alloc] initWithFrame:CGRectMake((rect.size.width-260)/2, (rect.size.height-260)/2, size.width, size.height)];
