...
#import "OrzOSDKBranch_ChuDian.h"

@implementation OrzOSDKBranch_ChuDian
...
-(void)doOrzOSDKChannelInit{
    NSLog(@"OrzOSDKBranch_ChuDian doChannelInit  !");
    ...
    //配置对应的appId
    config.appId = [[NSString alloc] initWithFormat:@"%@", [channel_config objectForKey:@"channel_chudian_appid"]];
    //配置对应的appKey
    config.appKey = [[NSString alloc] initWithFormat:@"%@", [channel_config objectForKey:@"channel_chudian_appkey"]];
...
-(void)doOrzOSDKChannelLogin{
    ...
    NSLog(@"OrzOSDKBranch_ChuDian doChannelLogin");
    [BTGOSDK login];
}
