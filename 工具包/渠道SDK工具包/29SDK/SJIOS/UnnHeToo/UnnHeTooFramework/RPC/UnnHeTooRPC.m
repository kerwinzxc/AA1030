...
@implementation UnnHeTooRPC



+ (void)requestPostUnnHeTooUrl:(NSURL *)requestPath
              ...
              failedBlock:(UnnHeToo_VE_BLOCK)failedBlock
{
    ...
    NSString* strParams = [self encodeHttpUnnHeTooParams:httpParams encode:NSUTF8StringEncoding];
...
+(NSString*) encodeHttpUnnHeTooParams:(NSDictionary*)params encode:(NSStringEncoding)encoding
{
