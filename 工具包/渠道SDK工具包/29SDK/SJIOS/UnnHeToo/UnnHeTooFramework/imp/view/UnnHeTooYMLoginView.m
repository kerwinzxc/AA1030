...
@property(nonatomic,strong) UnnHeTooBaseView *baseView;
@property(nonatomic,strong) UnnHeTooYMLoginView *ymLoginView;//登录界面
...
@implementation UnnHeTooYMLoginView
...
- (void) YMloginPressed:(UIButton*)sender
{
    ...
    {
        [[UnnHeTooSdkImp sharedInstance]showUnnHeTooToast:@"用户名不能为空"];
        return;
    }
...
-(void)ymStartLogin{
        ...
        @try{
            ...
            if ((NSNull *)value == nil)
            {
                ...
                if(self.textIsphoneNumber){
                    ...
                    [[UnnHeTooSdkImp sharedInstance] addUnnHeTooUser:username password:password bind:@"0" tourist:@"0" phoneNumber:@"0"];
                }
    ...
    if(self.textIsphoneNumber){//手机号登录
        ...
        [[UnnHeTooCommonApi sharedInstance] login:username
        ...
        @try{
            ...
            if ((NSNull *)value == nil)
            {
                ...
                if(self.isRegister == YES){
                    [[UnnHeTooSdkImp sharedInstance] showUnnHeTooShiMingRenZhengView:self.token callback:^(NSString *callbackxxxx){
                        NSString * userid = [dictionary valueForKey:@"id"];
                        ...
                        if ([self.loginInfo.tourist isEqualToString:@"1"]&&[self.loginInfo.bind isEqualToString:@"0"]) {
                            ...
                            [[UnnHeTooSdkImp sharedInstance] showUnnHeTooToast:@"该帐号为快速登录帐号,请尽快绑定,以免帐号丢失!"];
                        }
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    ...
    else if(textField==self.password)
    {
        ...
        if ([username length] == 0)
        {
            ...
            [[UnnHeTooSdkImp sharedInstance]showUnnHeTooToast:@"用户名为空"];
