...
@property(nonatomic,strong) UnnHeTooForgetView *ymForgetView;//忘记密码找回界面
...
@implementation UnnHeTooForgetView
...
-(void)setLandScapeView{
    ...
    UIImage *shengsubackImage = [[UIImage alloc]initWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_login_button.png"]] ;
    ...
    [imageView setImage:shengsubackImage];
    ...
    accountField.background = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_register_edit_background.png"]];
    ...
    verifyField.background = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_register_edit_background.png"]];
    ...
    //获取验证码按钮
    UIButton *verifyButton = [[UIButton alloc]initWithFrame:CGRectMake(275, 115, 120, 38)];
    UIImage *verifybackImage = [[UIImage alloc]initWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_login_button.png"]] ;
    //    [shensuFindPasswordButton setImage:shengsubackImage forState:UIControlStateNormal];
    //    [shensuFindPasswordButton setTitle:@"客服申诉找回" forState:UIControlStateNormal];
    ...
    UILabel *verifyLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 120, 38)];
    ...
    newPasswordField.background = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_register_edit_background.png"]];
...
-(void)setPortraitView{
    ...
    [shensuFindPasswordButton setBackgroundImage:[UIImage imageNamed:@"UnnHeToo.bundle/UnnHeToo_login_button.png"] forState:UIControlStateNormal];
    [shensuFindPasswordButton addTarget:self action:@selector(ym_shensuForgetClick) forControlEvents:UIControlEventTouchUpInside];
    [self.alertContainer addSubview:shensuFindPasswordButton];
    ...
    //获取验证码按钮
    UIButton *verifyButton = [[UIButton alloc]initWithFrame:CGRectMake(145, 115, 100, 38)];
    ...
    [verifyButton setBackgroundImage:[UIImage imageNamed:@"UnnHeToo.bundle/UnnHeToo_login_button.png"] forState:UIControlStateNormal];
    [verifyButton addTarget:self action:@selector(verifyPressed) forControlEvents:UIControlEventTouchUpInside];
    [self.alertContainer addSubview:verifyButton];
    self.getVerify = verifyButton;
...
{
    UnnHeToo_VSD_BLOCK successBlock= ^(NSDictionary *dictionary, NSDictionary *header) {
        ...
        if ([dictionary objectForKey:@"error"] == nil) {
            ...
            UnnHeTooForgetEmailView *forgetView = [[UnnHeTooForgetEmailView alloc]initWithLandscape:self.landscape phone:self.phone qq:self.qq];
    ...
    [[UnnHeTooCommonApi sharedInstance]getUnnHeTooSupport:[[UnnHeTooSdkImp sharedInstance]appId] onSuccess:successBlock onFailed:^(NSError *error) {
        [[UnnHeTooCommonApi sharedInstance]getUnnHeTooSupport:[[UnnHeTooSdkImp sharedInstance]appId] onSuccess:successBlock onFailed:^(NSError *error) {
...
- (void)verifyPressed
{
    ...
    {
        [[UnnHeTooSdkImp sharedInstance]showUnnHeTooToast:@"手机号为空"];
        return;
    ...
    [[UnnHeTooCommonApi sharedInstance] changeUnnHeTooPasswordByPhone:username
...
//                process.labelText = [[UnnHeTooSdkImp sharedInstance] translateUnnHeToo:[dictionary valueForKey:@"error"]];
        ...
        [[UnnHeTooCommonApi sharedInstance] confirmchangeUnnHeTooPasswordByPhone:username
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    if (textField == self.username){
        ...
        if ([verify length] == 0)
        {
            ...
            [[UnnHeTooSdkImp sharedInstance]showUnnHeTooToast:@"验证码为空"];
