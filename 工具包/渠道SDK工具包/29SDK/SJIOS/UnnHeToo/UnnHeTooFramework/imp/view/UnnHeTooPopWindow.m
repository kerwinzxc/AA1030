...
#import "UnnHeTooSettingViewController.h"
...
@interface UnnHeTooPopWindow()
@property (nonatomic) int show;
@property (nonatomic, strong)UnnHeTooSettingViewController *destionController;
@property (nonatomic, strong)UnnHeTooNavViewController *destionNavController;
...
@implementation UnnHeTooPopWindow


- (id)initWithFrameUnnHeTooPopWindow:(CGRect)frame controller:(UIViewController *)controller landspace:(BOOL) landspace accessToken:(NSString *)accessToken
{
    ...
    -(void)setLandScapeView{
        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_float_leftBackground_hengban.png"]] ;
        self.leftBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.leftBackground.image = leftbackImage;
        
        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_float_rightBackground_hengban.png"]] ;
        self.rightBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.rightBackground.image = rightbackImage;
        
        UIImage *floatImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_company_logo.png"]];
        ...
        UIImage *userInfoImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_userinfo_server.png"]] ;
        ...
        UIImage *hideFloatUnnHeTooImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_float_hide.png"]] ;
        [self.ymFloatHideButton setImage:hideFloatUnnHeTooImage forState:UIControlStateNormal];
        [self.ymFloatHideButton addTarget:self action:@selector(ym_hideUnnHeTooPopWindow:) forControlEvents:UIControlEventTouchUpInside];
    ...
    -(void)setPortraitView{
        ...
        //        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_float_leftBackground.png"]] ;
        UIImage *leftbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_float_Background_shuban.png"]] ;
        self.leftBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.leftBackground.image = leftbackImage;
        
        //        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_float_rightBackground.png"]] ;
        UIImage *rightbackImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_float_Background_shuban.png"]] ;
        self.rightBackground= [[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 155, 50)];
        self.rightBackground.image = rightbackImage;
...
-(void)setFloatButtonBackground{
    ...
    UnnHeToo_VSD_BLOCK completionBlock = ^(NSDictionary *responseString, NSDictionary *headers) {
            ...
            UIImage *normalAccountImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_userinfo_server.png"]] ;
...
-(void)serviceClick{
    if (self.controller == nil) {
        ...
        if (self.destionController == nil) {
            self.destionController = [[UnnHeTooSettingViewController alloc]initWithTransitionStyle:UIPageViewControllerTransitionStyleScroll navigationOrientation:UIPageViewControllerNavigationOrientationHorizontal options:NULL];
            self.destionNavController = [[UnnHeTooNavViewController alloc]initWithRootViewController:self.destionController];
...
//隐藏悬浮框
-(void)ym_hideUnnHeTooPopWindow:(id)sender {
    
    [UnnHeTooSdk hideFloatUnnHeToo];
