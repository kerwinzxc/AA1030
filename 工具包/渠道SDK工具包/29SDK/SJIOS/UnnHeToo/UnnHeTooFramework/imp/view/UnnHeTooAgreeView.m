...
#import "UnnHeTooAgreeView.h"
#import "UnnHeTooSdkImp.h"

@interface UnnHeTooAgreeView()
...
static NSString * LOG_TAG = @"UnnHeTooAgreeView";



@implementation UnnHeTooAgreeView
         ...
         landScape:(Boolean)landScape
{
    ...
    if (self) {
        ...
        self.alertContainer.backgroundColor=[UIColor colorWithPatternImage:[UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_agreeBG.png"]]];
