...
@interface UnnHeTooWindowTouch()
@property(nonatomic,strong)UnnHeTooPopwidowViewController *popcontroller;
@property(nonatomic,unsafe_unretained)id<UnnHeTooWindowTouchDelegate> assistiveDelegate;
@property (nonatomic) float lastX;
@property (nonatomic) float lastY;
@end
@implementation UnnHeTooWindowTouch
...
-(id)initWithFrame:(CGRect)frame
{
    if(self = [super initWithFrame:frame])
    {
        ...
        self.popcontroller=[[UnnHeTooPopwidowViewController alloc]initWithUnnHeTooPopWindow:self];
