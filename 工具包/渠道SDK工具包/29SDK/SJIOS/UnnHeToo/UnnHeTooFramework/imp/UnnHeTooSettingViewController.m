...
#import "UnnHeTooServiceViewController.h"
#import "UnnHeTooFloatViewController.h"
#import "UnnHeTooSdkImp.h"
@interface UnnHeTooSettingViewController ()

@property (strong, nonatomic) UnnHeTooServiceViewController *UnnHeTooServiceViewController;
@property (strong, nonatomic) UnnHeTooAccountViewController *accountController;
@property (strong, nonatomic) UnnHeTooAccountViewController *accountController2;

@property (strong, nonatomic) UIView *container;
@property (strong, nonatomic) UIView *serviceContainer;
@property (strong, nonatomic) UIView *accountContainer;
@property (strong, nonatomic) UIView *hideFloatUnnHeTooContainer;
...
@implementation UnnHeTooSettingViewController
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    self.UnnHeTooServiceViewController = [[UnnHeTooServiceViewController alloc]initWithLandscape:self.landscape];
    self.UnnHeTooServiceViewController.pageIndex = 0;
    self.UnnHeTooServiceViewController.view.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    
    self.accountController = [[UnnHeTooAccountViewController alloc]initWithLandscape:self.landscape];
    ...
    UnnHeTooFloatViewController *targetController;
    if (self.pageIndex == 0) {
        targetController = self.UnnHeTooServiceViewController;
...
-(void)initNavigation {
    UIImage *backNormalImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_back.png"]] ;
    UIImage *backHighImage = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_back_cl.png"]] ;
...
//    UIImage *backgroundImage = [UIImage imageWithColor:[UIColor colorWithRed:0.1176 green:0.5255 blue:0.855 alpha:1.0] cornerRadius:3.0f sizeOfdialog:CGSizeMake(screenSize.width, 44)];
 ...
 //   [self.navigationController.navigationBar setBackgroundImage:backgroundImage forBarMetrics:UIBarMetricsDefault];
   // self.navigationController.navigationBar.tintColor=[UIColor colorWithRed:0.1176 green:0.5255 blue:0.855 alpha:1.0];
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_icon_meun_ser.png"]] ;
    ...
    accountImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_icon_meun_ac.png"]] ;
...
-(void)serviceTap {
    ...
    [self.serviceContainer addSubview:self.blueBar];
    self.pageIndex = 0;
    [self setViewControllers:@[self.UnnHeTooServiceViewController]
                   direction:UIPageViewControllerNavigationDirectionForward
                    animated:NO
                  completion:NULL];
}
...
- (UIViewController *)pageViewController:(UIPageViewController *)pvc viewControllerBeforeViewController:(UnnHeTooFloatViewController *)vc
{
    if (vc.pageIndex == 1) {
        self.UnnHeTooServiceViewController.delegate = self;
        self.pageIndex = 0;
        return self.UnnHeTooServiceViewController;
    }
    return nil;
}

- (UIViewController *)pageViewController:(UIPageViewController *)pvc viewControllerAfterViewController:(UnnHeTooFloatViewController *)vc
{
    if (vc.pageIndex == 0) {
