...
#import  "UnnHeTooSdkImp.h"
@interface UnnHeTooBindPhoneViewController ()
...
@implementation UnnHeTooBindPhoneViewController
...
-(void)initNavigation {
    ...
    serviceImageView.image = [UIImage imageWithContentsOfFile:[[[NSBundle mainBundle]resourcePath]stringByAppendingPathComponent:@"UnnHeToo.bundle/UnnHeToo_icon_meun_bangding.png"]];
...
//    [sureButton setButtonColor:[UIColor colorWithRed:0.91 green:0.498 blue:0 alpha:1.0]];
//    [sureButton setHighColor:[UIColor colorWithRed:0.761 green:0.467 blue:0.145 alpha:1.0]];
//    [sureButton setCornerRadius:3];
