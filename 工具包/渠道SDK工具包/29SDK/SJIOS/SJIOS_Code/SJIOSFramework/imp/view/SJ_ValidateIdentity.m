...
-(void) comfirmPressed{
    ...
    [[SJIOSCommonApi sharedInstance] startSJIOSIdentify:self.accesstoken name:[self.name.text stringByReplacingOccurrencesOfString:@" " withString:@""] identifyNumber:[self.identity.text stringByReplacingOccurrencesOfString:@" " withString:@""] completionBlock:completionBlock failedBlock:^(NSError *error) {
