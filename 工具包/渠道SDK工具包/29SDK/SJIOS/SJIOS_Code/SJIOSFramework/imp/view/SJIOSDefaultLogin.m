...
@property (nonatomic,strong) SJIOSBind *bindview;
...
- (void) startLogin
{
    ...
    if([self.loginInfo.password isEqualToString:@"0"]){
        ...
        //if (self.ymLoginView==nil) {
            self.ymLoginView=[[SJIOSYMLoginView alloc]initWithBlock:self.success failed:self.failed landScape:self.landscape view:self username:self.loginInfo.username];
        //}
        ...
        @try{
            ...
            if ((NSNull *)value == nil)
            {
                ...
                if(self.isRegister == YES){
                    [[SJIOSSdkImp sharedInstance] showSJIOSShiMingRenZhengView:self.token callback:^(NSString *callbackssss){
    ...
    if([self.loginInfo.phoneNumber isEqual:@"1"]){
        ...
        [[SJIOSCommonApi sharedInstance] phoneSJIOSLogin:self.loginInfo.username
                                          password:password
...
- (void) registerPressed
{
    ...
    if ([self.loginInfo.tourist isEqual:@"1"]&&[self.loginInfo.bind isEqual:@"0"]) {
        ...
        if(self.bindview==nil){
            self.bindview=[[SJIOSBind alloc]initWithBlock:^(NSString *username, NSString *password) {
...
-(void) tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.dataList.count>0) {
        ...
        [self dismissWithAnimation:YES];
        [[SJIOSSdkImp sharedInstance]loginSJIOS:[SJIOSSdkImp sharedInstance].rootControllerView landscape:self.landcape success:self.success failed:self.failed flag:1];
    }
