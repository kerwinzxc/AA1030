...
-(void)fastRegister{
            ...
            if ((NSNull *)value == nil)
            {
                ...
                if ([type isEqualToString:@"1"]) {//type=1没绑定手机 type=0已绑定手机
                    ...
                    if([is_register isEqualToString:@"1"]){
                        ...
                        [[SJIOSSdkImp sharedInstance] sjRegister:[dictionary valueForKey:@"id"]];
    ...
    [[SJIOSCommonApi sharedInstance]fastSJIOSRegister:completionBlock
...
- (void) startLogin:(SJIOSUserInfo *) userinfo
{
            ...
            if ((NSNull *)value == nil)
            {
                ...
                if(self.isRegister == YES){
                    [[SJIOSSdkImp sharedInstance] showSJIOSShiMingRenZhengView:self.token callback:^(NSString *callbackssss){
                        ...
                        [[SJIOSSdkImp sharedInstance] addSJIOSUser:userinfo.username password:userinfo.password bind:userinfo.bind tourist:userinfo.tourist phoneNumber:userinfo.phoneNumber];
    ...
    [[SJIOSCommonApi sharedInstance] login:userinfo.username
                                 password:password
