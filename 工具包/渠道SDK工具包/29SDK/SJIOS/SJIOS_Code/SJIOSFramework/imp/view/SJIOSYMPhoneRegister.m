...
@interface SJIOSYMPhoneRegister()
...
@implementation SJIOSYMPhoneRegister
...
-(void)ym_verifyPressed:(id)sender {
    ...
    [[SJIOSCommonApi sharedInstance] phoneSJIOSRegistVerify:self.ymPhoneNumber
...
//                [self setRandomAccount];
    ...
    [[SJIOSCommonApi sharedInstance] phoneSJIOSRegist:self.ymPhoneNumber
