...
@interface SJIOSRegisterView()<UIAlertViewDelegate>
...
@property(nonatomic,strong) SJIOSRegisterView *ymRegisterView;//帐号注册界面

@end

@implementation SJIOSRegisterView
...
- (void)normalPressed
{
    ...
    [[SJIOSCommonApi sharedInstance] normalSJIOSRegister:username
