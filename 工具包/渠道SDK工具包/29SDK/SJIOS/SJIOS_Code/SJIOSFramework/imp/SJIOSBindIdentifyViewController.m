...
- (void)normalPressed
{
    ...
    [[SJIOSCommonApi sharedInstance] startSJIOSIdentify:self.accessToken name:identifyNameField.text identifyNumber:identifyNumberField.text completionBlock:completionBlock failedBlock:^(NSError *error) {
