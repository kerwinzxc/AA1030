...
-(void)changePassword {
    ...
    [[SJIOSCommonApi sharedInstance]changeSJIOSPasswordWithToken:self.accessToken oldPassword:oldPassword newPassword:[SJIOSSdkMd5 md5:newPassword] completionBlock:completionBlock failedBlock:^(NSError *a) {
